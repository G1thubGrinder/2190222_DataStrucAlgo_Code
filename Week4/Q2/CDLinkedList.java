...
public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) throws Exception{
		try {
			DListIterator ss1 = (DListIterator) s1;
			DListIterator ff1 = (DListIterator) f1;
			DListIterator ss2 = (DListIterator) s2;
			DListIterator ff2 = (DListIterator) f2;
			DListNode c1 = ss1.currentNode;
			DListNode d1 = ff1.currentNode;
			DListNode c2 = ss2.currentNode;
			DListNode d2 = ff2.currentNode;
			DListNode b1 = c1.previousNode;
			DListNode a1 = d1.nextNode;
			DListNode b2 = c2.previousNode;
			DListNode a2 = d2.nextNode;
			if(a1 == c2) {
				b1.nextNode = c2;
				c2.previousNode = b1;
				d2.nextNode = c1;
