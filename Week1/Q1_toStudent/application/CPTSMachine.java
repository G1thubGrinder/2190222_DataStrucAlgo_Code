package HW.Week1.Q1_toStudent.application;
import HW.Week1.Q1_toStudent.logic.Station;
import HW.Week1.Q1_toStudent.logic.Ticket;
...
public class CPTSMachine {
	...
	public static boolean buyTicket(int typ, Station start, Station end) {
		Ticket ticket = new Ticket(typ, start, end);
		if((start != null && end != null) && (typ >= 0 && typ <= 2) && ticket.calculatePrice() != -1 && isStationExisted(start.getName()) && isStationExisted(end.getName())) {
