...
public class CDLinkedList {
	...
	public void insert(char value, Iterator p) throws Exception {
	...
	// otherwise, return -1.
	public int find(char value) throws Exception {
	...
	public char findKth(int kthPosition) throws Exception {
	...
	public Iterator findPrevious(char value) throws Exception {
		if (isEmpty())
			return null;
		Iterator itr1 = new DListIterator(header);
		Iterator itr2 = new DListIterator(header);
		char currentData = itr2.next();
	...
	public void remove(char value) throws Exception {
	...
	// Print each contact out into a string, one by one.
